class Player {
  ...
  selectMove() {
    ...
    while (true) {
      this.pokemon.setCurrenMove = prompt(// promp tomara el dato que se le de
...
class Bot extends Player {
  ...
  selectMove() {
    // let setCurrentMove;
if (randomBetween < .5) {//solo tenemos 2 ataques asi que solo ocupamos un numero entre ellos
